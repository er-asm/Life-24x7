...
public class GoogleStory extends AppCompatActivity {
    TextView largeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_google_story);
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("lifestories/googlestory.json");
