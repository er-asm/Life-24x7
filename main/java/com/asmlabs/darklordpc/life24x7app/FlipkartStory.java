...
public class FlipkartStory extends AppCompatActivity {
    TextView largeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flipkart_story);
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("lifestories/flipkartstory.json");
