...
public class LincolnStory extends AppCompatActivity {
    TextView largeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lincoln_story);
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("lifestories/lincolnstory.json");
