...
public class RajendraPrasadStory extends AppCompatActivity {
    TextView largeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rajendra_prasad_story);
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("lifestories/rajendraprasad.json");
