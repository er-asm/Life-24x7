...
public class SardarVallabhaiPatelStory extends AppCompatActivity {
    TextView largeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sardar_vallabhai_patel_story);
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getAssets().open("lifestories/sardarjistory.json");
